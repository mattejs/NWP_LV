                    ...
                    <div class="card-body">
                        ...
                        @if($project->leader == Auth::user()->getId())
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="number" min="1" step="any" name="price" id="price" value="{{$project->price}}" required>
                            </div>
                        @endif
                            <div class="form-group row">                        
                        ...
                        @if($project->leader == Auth::user()->getId())
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="date" name="startdate" id="Start date" value="{{$project->start_date}}" required>
                            </div>
                            <div class="form-group row">
                                <label for="enddate">End date: </label>
                                <input class="form-control" type="date" name="enddate" id="enddate" value="{{$project->end_date}}" required>
                            </div>
                        @endif
